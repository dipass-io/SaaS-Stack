...
const BasejumpHomepage = () => (
  <div className="max-w-screen-lg mx-auto bg-base-100">
    <ContentMeta
      title="Dipassio - SaaS - AI"
      description="An opinionated short cut for launching your apps using lastest technologies"
      socialImage={`/api/og?title=Basejump`}
    />
    <div className="pt-8 pb-24 md:pt-36 md:pb-48">
      <Logo size="lg" className="mx-auto" />
      <h2 className="h2 text-center my-2">
      Get your landing page Dipassied for 99€ 🔥{""}
    ...
    <div className="grid grid-cols-1 gap-y-8 lg:gap-y-16">
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col bg-base-200 rounded-lg p-6">
            ...
            <p>
              Dipassio leverages DaisyUI and TailwindCSS for an easy development
              experience
            </p>
          </div>
          <div className="flex flex-col bg-base-200 rounded-lg p-6">
          ...
          <div className="flex flex-col bg-base-200 rounded-lg p-6">
            ...
            <p>
              Dipassio is a batteries-included starting point for your
          ...
          <div className="flex flex-col bg-base-200 rounded-lg p-6 md:col-span-3">
            ...
            <p>
              Dipassio is open source, contributions are both awesome and
              encouraged!
            </p>
          </div>
        </div>
      ...
      <div className="max-w-screen-md mx-auto">
        ...
        <p>
          Dipassio is built using some really awesome open source libraries and
          ...
          <li>
            ...
            >
              ...
              <p>
                ...
                the primary force behind Dipassio
              </p>
            </a>
          </li>
          <li>
        ...
        <ul className="my-4 mx-4 list-disc grid gap-y-1">
          ...
          <li>
            <a
              ...
              title="Dipassio dude credit"
              target="_blank"
              rel="noopener noreferrer"
            >
              Our awesome Dipassioer dude was created by monkik
            </a>
          </li>
          <li>
            <a
